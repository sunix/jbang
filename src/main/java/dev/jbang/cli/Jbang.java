...
@Command(name = "jbang", footer = "\nCopyright: 2020 Max Rydahl Andersen, License: MIT\nWebsite: https://jbang.dev", description = "Build and runs .java/.jsh scripts and jar packages.", versionProvider = VersionProvider.class, subcommands = {
...
public class Jbang extends BaseCommand {
	...
	public static CommandGroupRenderer getCommandRenderer() {
		...
		sections.put("Essentials", asList("run", "build", "cache"));
		sections.put("Editing", asList("init", "edit"));
		sections.put("Configuration", asList("trust", "alias", "catalog", "jdk"));
